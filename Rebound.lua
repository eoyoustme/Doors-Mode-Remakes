...
face.Texture = "rbxassetid://77083634265387"
face.Speed = NumberRange.new(5, 5)
face.Rate = 50
face.RotSpeed = NumberRange.new(-5, 5)
face.Color = ColorSequence.new(Color3.fromRGB(255, 0, 0))
...
if v4 == 1 then
	l__ImageLabel__1.Image = "rbxassetid://77083634265387";
end;
if v4 == 2 then
	l__ImageLabel__1.Image = "rbxassetid://77083634265387";
end;
